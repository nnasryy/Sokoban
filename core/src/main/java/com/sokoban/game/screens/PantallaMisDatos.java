...
public class PantallaMisDatos extends PantallaBase {
    ...
    private BitmapFont fuenteLabel;   // Pixellari60
    ...
    public void show() {
        ...
        texBtnGuardar = new Texture("imagenes/botones/signup_button.png"); // reutiliza
        ...
        // Campo Password — editable, oculto por defecto
        ...
        btnOjo.addListener(new ClickListener() {
            ...
            public void clicked(InputEvent e, float x, float y) {
                ...
                btnOjo.getStyle().imageUp = new TextureRegionDrawable(
                        new TextureRegion(mostrarPassword ? texOjoAbierto : texOjoCerrado));
            }
        });
    ...
    private void guardarCambios() {
        ...
        // Solo cambia la contraseña si escribió algo nuevo
    ...
    public void render(float delta) {
        ...
        fuenteTitulo.draw(batch, ingles ? "MY DETAILS" : "MIS DATOS", 48.2f, 550 - 55f);

        fuenteLabel.setColor(Color.WHITE);
        fuenteLabel.draw(batch, ingles ? "NAME:" : "NOMBRE:", 55f, 550 - 170.6f);
        fuenteLabel.draw(batch, ingles ? "USER:" : "USUARIO:", 54.2f, 550 - 242.1f);
        fuenteLabel.draw(batch, ingles ? "PASSWORD:" : "PASSWORD:", 54.2f, 550 - 302.5f);

        // Requisitos de contraseña
        // Requisitos de contraseña — misma Y, X separadas
        float yReq = 550 - 371.5f;

        fuente18.setColor(colorEspecial);
        fuente18.draw(batch, ingles ? "SPECIAL CHARACTERS" : "CARACTERES ESPECIALES",
                100f, yReq);

        fuente18.setColor(colorNumero);
        fuente18.draw(batch, ingles ? "NUMBER" : "NUMERO", 320f, yReq);

        fuente18.setColor(colorCaract);
        fuente18.draw(batch, "5 " + (ingles ? "CHARACTERS" : "CARACTERES"),
                420f, yReq);
