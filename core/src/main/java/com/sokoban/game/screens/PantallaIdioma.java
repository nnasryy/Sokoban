...
public class PantallaIdioma extends PantallaBase {
    ...
    private void cambiarIdioma(String idioma) {
        ...
        // Actualizar flag local para que el título cambie de inmediato
        ingles = "en".equals(idioma);
 
        // Recrear PantallaConfiguracion para que recargue botones en el nuevo idioma
        juego.setScreen(new PantallaConfiguracion(juego));
    }
    ...
    public void dispose() {
        ...
        if (texEnglish  != null) texEnglish.dispose();
        if (texEspaniol != null) texEspaniol.dispose();
